...
```{r}
filtM <- filterfun(pOverA(0.062,5))
#filtF <- filterfun(pOverA(1,5)) #used to be this
...
```
This is a different number post filter compared to females.
...
Choosing power of 5, but could also choose 7 probably.
...
pdf(file = "~/github/oyster-lnc/output/12-WGCNA-lncRNA/M_heatmap.pdf", height = 40, width = 10)
Heatmap(moduleTraitCor, name = "Eigengene", row_title = "Gene Module", column_title = "Module-Treatment Eigengene Correlation", 
        col = blueWhiteRed(50), 
        row_names_side = "left", 
        #row_dend_side = "left",
...
#convert wide format to long format for plotting  
plot_MEs<-Strader_MEs%>%
  gather(., key="Module", value="Mean", 1:185)
...
pdf(file="~/github/oyster-lnc/output/M_expression_plot.pdf", width = 5, height = 12)
expression_plot
dev.off()
...
pdf(file="~/github/oyster-lnc/output/M_expression_plot_treatment.pdf", width = 5, height = 12)
expression_plot_treatment
dev.off()

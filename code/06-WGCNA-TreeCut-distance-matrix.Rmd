...
Before filtering, we had 34,223 genes. After filtering for pOverA, we have approximately 11,475 genes. This indicates that there were many genes present in <7% of samples at <5 counts per gene.  
...
ggsave("Mcap2020/Figures/TagSeq/GenomeV3/genes_lifestagePCA.pdf", genesPCA, width=6, height=5, dpi=300)
```
